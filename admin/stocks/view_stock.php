...
?>
<div class="content bg-gradient-blue py-5 px-4">
...
<div class="row mt-n4 justify-content-center">
    <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
        ...
        <div class="card card-outline card-blue rounded-0 shadow printout">
                ...
                <div class="container-fluid">
                    <fieldset>
                        <div class="d-flex w-100">
                            <div class="col-4 bg-gradient-blue m-0 p-1 border">Category</div>
                            <div class="col-8 m-0 p-1 border"><?= isset($category) ? $category : '' ?></div>
                        </div>
                        <div class="d-flex w-100">
                            <div class="col-4 bg-gradient-blue m-0 p-1 border">Item Name</div>
                            <div class="col-8 m-0 p-1 border"><?= isset($name) ? $name : '' ?></div>
                        </div>
                        <div class="d-flex w-100">
                            <div class="col-4 bg-gradient-blue m-0 p-1 border">Unit</div>
                            <div class="col-8 m-0 p-1 border"><?= isset($unit) ? $unit : '' ?></div>
                        </div>
                        <div class="d-flex w-100">
                            <div class="col-4 bg-gradient-blue m-0 p-1 border">Available</div>
        ...
        <div class="d-flex w-100">
            ...
            <div class="d-flex w-10 ">
                <div style="line-height:1em">
                    ...
                    <h3 class="font-weight-bold mb-0"><large>Pranish Inc. Supply Chain System - Stock Details</large></h3>
                    <!-- <h3 class="font-weight-bold mb-0"><large>Stock Details</large></h3> -->
                </div>
            </div>
        </div>
