                ...
                <div class="container-fluid" id="printout">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $g_total = 0;
                            $i = 1;
                            $stock = $conn->query("SELECT s.*, i.name as `item`, c.name as `category`, i.unit FROM `waste_list` s inner join `item_list` i on s.item_id = i.id inner join category_list c on i.category_id = c.id where date_format(s.date, '%Y') = '{$year}' order by date(s.`date`) asc");
    ...
    <div>
        ...
        <div class="d-flex w-100 align-items-center">
            ...
            <div class="col-8">
                <div style="line-height:1em">
                    <!-- <div class="text-center font-weight-bold h5 mb-0"><large><?= $_settings->info('name') ?></large></div> -->
                    <div class="font-weight-bold h5 mb-0"><large>Pranish Inc. Supply Chain System Yearly Waste Report</large></div>
...
<script>
    ...
    $(function(){
        $('#filter-form').submit(function(e){
            e.preventDefault()
            location.href = './?page=reports/ywaste&'+$(this).serialize()
        })
