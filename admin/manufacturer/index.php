        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `manufacturer_list` where delete_flag = 0 order by `id` asc ");
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this manufacturer permanently?","delete_manufacturer",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='far fa-plus-square'></i> Add New manufacturer ","manufacturer/manage_manufacturer.php")
		})
		$('.edit-data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Add New manufacturer ","manufacturer/manage_manufacturer.php?id="+$(this).attr('data-id'))
		})
		$('.view-data').click(function(){
			uni_modal("<i class='fa fa-th-list'></i> manufacturer Details ","manufacturer/view_manufacturer.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
