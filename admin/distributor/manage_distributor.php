...
<script>
	$(document).ready(function(){
		$('#distributor-form').submit(function(e){
			...
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Master.php?f=save_distributor",
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
						...
						uni_modal("<i class='fa fa-th-list'></i> distributor Details ","distributor/view_distributor.php?id="+resp.cid)
